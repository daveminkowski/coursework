...
public class JShapes2D extends JPanel {
    ...
    public void paintComponent(Graphics gr)
    {
        ...
        Rectangle2D.Float rect2 = new Rectangle2D.Float(20F, 70F, 40F, 40F);
        gr2D.draw(rect); gr2D.fill(rect2);
        ...
        Arc2D.Float ac = new Arc2D.Float(20F, 220F, 50F, 50F, 30F, 120F, Arc2D.PIE);
        Arc2D.Float ac2 = new Arc2D.Float(20F, 270F, 50F, 50F, 30F, 120F, Arc2D.PIE);
        gr2D.draw(ac);
        gr2D.fill(ac2);
